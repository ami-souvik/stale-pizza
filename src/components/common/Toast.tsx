...
import { type Toast as ToastType, useToast } from '../../providers/ToastProvider';
...
function ToastItem({ toast, onRemove }: ToastItemProps) {
    const getStyles = () => {
        const baseStyles = 'flex items-center justify-between p-4 rounded-lg shadow-lg mb-2 min-w-[300px] max-w-md animate-slide-in';
